...
public class MainWindow {
	...
	private void addSelectionListenerForMenuItemOfNews() {
		...
		mi_hero.addSelectionListener(new SelectionAdapter() {
			...
			@Override
			public void widgetSelected(SelectionEvent e) {
				BrowserWindow container = new BrowserWindow(SysConfigLoader.getProperty("addr.exposion.hero"), mi_hero.getText());
				container.open();
			}
		});
		mi_skin.addSelectionListener(new SelectionAdapter() {
			...
			@Override
			public void widgetSelected(SelectionEvent e) {
				BrowserWindow container = new BrowserWindow(SysConfigLoader.getProperty("addr.exposion.skin"), mi_skin.getText());
				container.open();
			}
		});
		mi_redesign.addSelectionListener(new SelectionAdapter() {
			...
			@Override
			public void widgetSelected(SelectionEvent e) {
				BrowserWindow container = new BrowserWindow(SysConfigLoader.getProperty("addr.exposion.redesign"), mi_redesign.getText());
				container.open();
			}
		});
